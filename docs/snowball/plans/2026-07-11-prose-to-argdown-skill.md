...
=== title: "The case for climate action" source: "(test fixture)" extracted-from: lines 1-14 validated: 2026-07-11 ===

[#co2-primary-cause] Human CO2 emissions are the primary driver of current warming trends. { source-line: 2, source-quote: "According to the IPCC's Sixth Assessment Report, human CO2 emissions are the primary driver of current warming trends" }
[#impacts-observable] Current warming trends have observable impacts on ecosystems worldwide. { source-line: 2, source-quote: "with observable impacts on ecosystems worldwide" }
...
[#impacts-observable] --> [#comprehensive-approach] { source-line: 2, source-quote: "with observable impacts on ecosystems worldwide" }
[#impacts-will-escalate] --> [#comprehensive-approach] { source-line: 3, source-quote: "Without coordinated international response, these impacts will continue to escalate" }
...
([#comprehensive-approach]) -> [#co2-primary-cause], [#impacts-observable], [#impacts-will-escalate], [#stern-review-costs], [#renewables-more-jobs], [#market-signals-corporate], [#ev-manufacturer-response], [#facts-are-clear], [#economics-support], [#urgency-cannot-be-denied]. { source-line: 13, source-quote: "Therefore, a comprehensive approach combining policy reform, technological investment, and behavioral change offers the best path forward" }
