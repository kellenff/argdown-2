...
This repo is a Claude Code marketplace. Installing the `argdown-2` plugin registers the MCP server and ships skills for prose extraction / build / validate / solve (`prose-to-argdown-2`, `build-graph`, `validate-debug`, `interpret-solve`).
